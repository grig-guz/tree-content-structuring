...
from dataset.utils.token import Token
...
if __name__ == '__main__':
    doc = Doc()
    fmerge = "../../data/stochastic_300k_preprocess_ternary/300k_10_STOCH_LIN_every_merge_whole_range_ternary_sentence_agg/auxDP_237831.out.merge"
